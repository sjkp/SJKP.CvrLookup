...
namespace SJKP.CvrClient.Models
{
    ...
    public partial class NyesteNavn
    {
        /// <summary>
        /// Initializes a new instance of the NyesteNavn class.
        /// </summary>
        public NyesteNavn() { }
        ...
        /// Initializes a new instance of the NyesteNavn class.
        /// </summary>
        public NyesteNavn(string navn = default(string), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            Navn = navn;
            Periode = periode;
